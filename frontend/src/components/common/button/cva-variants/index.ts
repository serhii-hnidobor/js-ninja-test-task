...
const buttonVariants = cva(['block', 'hover:cursor-pointer'], {
  variants: {
    intent: {
      primary: ['bg-blue', 'border-none', 'text-white'],
      primaryInvert: ['bg-black', 'text-yellow-light'],
      secondary: ['bg-transparent', 'border', 'border-yellow-light', 'text-yellow-light'],
      regularOutlined: ['bg-transparent', 'border', 'border-white', 'text-white'],
      base: [''],
      ...
      inline: ['inline-flex', '!p-0', 'justify-center', 'items-center', 'border-none'],
    },
    state: {
